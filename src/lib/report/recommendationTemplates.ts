...
const TEMPLATE_MATCHERS: TemplateMatcher[] = [
  {
    ...
    template: {
      ...
      howToFix:
        "Add JSON-LD Organization schema with name, url, logo, and sameAs social profiles in the page head.",
      expectedGain: 7,
      copyableExample: `<script type="application/ld+json">
{
  ...
  },
  {
    ...
    template: {
      ...
      howToFix:
        "Add og:image with a 1200×630px absolute URL, plus og:title and og:description on every key page.",
      expectedGain: 6,
...
<meta property="og:image:height" content="630" />`,
  ...
  },
  {
    ...
    template: {
      ...
      howToFix:
        "Add twitter:card summary_large_image plus twitter:image, twitter:title, and twitter:description tags.",
      expectedGain: 5,
...
<meta name="twitter:title" content="Your Page Title" />`,
  ...
  },
  {
    ...
    template: {
      ...
      howToFix:
        "Publish a /contact page with business name, email or phone, response expectations, and a link from the main navigation.",
      expectedGain: 6,
...
<p>Phone: +1 (555) 123-4567</p>`,
  ...
  },
  {
    ...
    template: {
      ...
      howToFix:
        "Add /privacy-policy and /terms pages, link them in the footer, and include last-updated dates on each policy.",
      expectedGain: 5,
...
<a href="/terms">Terms of Service</a>`,
  ...
  },
  {
    ...
    template: {
      ...
      howToFix:
        "Show author name and published/updated dates on the page, plus article:author or datePublished in JSON-LD Article schema.",
      expectedGain: 6,
      copyableExample: `<script type="application/ld+json">
{
  "@context": "https://schema.org",
  ...
  },
  {
    ...
    template: {
      ...
      howToFix:
        "Add a visible FAQ section with question headings and concise answers, then mirror it in FAQPage JSON-LD.",
      expectedGain: 7,
      copyableExample: `<script type="application/ld+json">
{
  "@context": "https://schema.org",
